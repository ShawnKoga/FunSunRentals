        ...
        const forecast = this.state.weatherForecast.map((c, i) => {
            return (
                <div key={i} className="forecast_day_plat">
                    ...
                    <div className="forecast_row">
                        <div className="forecast_title">Low:&nbsp;</div><div>{c.low.fahrenheit}</div>
                        <div className="forecast_title">High:&nbsp;</div><div>{c.high.fahrenheit}</div>
                    </div>
                    <div className="forecast_row">
                ...
                <section id="reservation_section" className="reservation_section">
                    ...
                    <section className="request_container">
                        <section className="main_request_container">
                            ...
                            {/* STEP TWO */}
                            <div className={this.state.custReqToggler === 2 ? "request_info_container show_req" : "request_info_container hide_req"}>
                                IS THIS YOU?
                                {isThisYouCust}
